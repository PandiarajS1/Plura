...
export default function Home() {
  return (
    <>
      ...
      <section className="md:mt-48 mt-10 flex justify-content items-center flex-col gap-4">
          <h2 className="text-4xl text-center">
            Choose what fits you right
          </h2>
          <p className="text-muted-foreground text-center">
            Our straightforward pricing plans are tailored to meet your needs. If {"you're"}
            not <br /> ready to commit you get started for free.
          </p>
